# Проект по автоматизации тестирования digitalleague.ru
<a href="https://www.digitalleague.ru/"><img width="30%" title="Tinkoff" src="images/logo/liga.png"></a>
...
- Проверка работы страницы 'Ищем сотрудников'
- Проверка работы станицы 'Делаем'
